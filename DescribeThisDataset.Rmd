...
if(Vars_Form_Det){
    ...
    for(i in Cols){
      if(ColsFormat[form_iteration]=="binary"){
        ...
        cat("\n")
        print(knitr::kable(DF_binary, col.names = c("Values", "Count", "Proportion")))
        cat("\n")
      ...
      if(ColsFormat[form_iteration]=="continuous"){
        ...
        var_mean= mean(Dataset[,get(i)], na.rm=TRUE)
        quantile_table=append(quantile_table, var_mean)
        names(quantile_table)=c("Minimum",   "25th Percentile ",  "Median",  "75th Percentile",  "Maximum", "Mean") 
        
        cat("\n")
        print(knitr::kable(quantile_table, col.names = c( "Value"),  caption = "Mean and Percentile table"))
        cat("\n")
