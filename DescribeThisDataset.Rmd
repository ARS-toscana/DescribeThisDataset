...
```{r Head, include=TRUE}
  if(HeadOfDataset==TRUE){
    t= knitr::kable(head(Dataset),  caption = "Head of the dataset")
    t=kable_material_dark(t)
    scroll_box(t, width = "100%")
  }
```
    ...
    for(i in Cols){
      ...
      if(ColsFormat[form_iteration]=="categorical"){
        ...
        for(z in category){
          ...
          percentage=append(percentage, count[[iteration_count]]/n_of_observations*100)
